    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-150 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <h1 class="mb-0">{{ temp_now }}</h1>
                    <div class="mb-1 text-muted">{{temp_high}}</div>
                    <div class="mb-1 text-muted">{{temp_low}}</div>
                </div>
                <div class="col-auto d-none d-lg-block">
                    <img src="/img/{{temp_icon}}" alt="100%x250" class="img-fluid">
                    <!--<svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg"
                         preserveAspectRatio="xMidYMid slice" focusable="false" role="img" src="/img/{{temp_icon}}"
        ...
        <div class="col-md-6">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <div class="mb-1 text-muted">{{suninfo}}</div>
                    <div id="chart" style="min-width: auto; height: auto; margin: 0 auto"></div>
                </div>
            </div>
        </div>
    </div>
